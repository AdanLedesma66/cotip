...
public final class CurrencyUtils {
    ...
    static {
        register("USD", "Dólar Americano", "US Dollar", QuoteModality.CASH, true,
                "DÓLAR AMERICANO", "DÓLAR EFECTIVO", "DOLAR EFECTIVO", "DOLAR AMERICANO",
                "DÓLAR AMERICANO EFECTIVO", "DOLAR", "DÓLAR", "DÓLARES");
        register("USD", "Dólar Cheque / Transferencia", "US Dollar Check/Transfer",
                QuoteModality.CHECK_TRANSFER, false,
                "DÓLAR CHEQUE / TRANSFERENCIA", "DÓLAR AMERICANO TRANSF.", "DOLAR CHQ./TRANSF.");
        register("USD", "Dólar x Euro Arbitraje", "Dollar to Euro Arbitrage",
                QuoteModality.ARBITRAGE, false,
                "DÓLAR X EURO");

        register("ARS", "Peso Argentino", "Argentine Peso", QuoteModality.CASH, true,
                "PESO ARGENTINO", "PESO ARGENTINO EFECTIVO", "PESOS ARG.", "PESO ARG", "PESO");
        register("ARS", "Peso x Dólar Arbitraje", "Peso to Dollar Arbitrage",
                QuoteModality.ARBITRAGE, false,
                "PESO X DÓLAR");

        register("BRL", "Real Brasileño", "Brazilian Real", QuoteModality.CASH, true,
                "REAL BRASILEÑO", "REAL EFECTIVO", "REALES", "REAL");
        register("BRL", "Real x Dólar Arbitraje", "Real to Dollar Arbitrage",
                QuoteModality.ARBITRAGE, false,
                "REAL X DÓLAR");

        register("EUR", "Euro Efectivo", "Euro Cash", QuoteModality.CASH, true,
                "EURO EFECTIVO", "EUR EFECTIVO", "EURO", "EUROS");
        register("EUR", "Euro Cheque / Transferencia", "Euro Check/Transfer",
                QuoteModality.CHECK_TRANSFER, false,
                "EURO TRANSFERENCIA", "EURO TRANSF.", "EURO CHEQUE / TRANSFERENCIA", "EURO CHQ./TRANSF.");

        register("CHF", "Franco Suizo", "Swiss Franc", QuoteModality.CASH, true,
                "FRANCO SUIZO", "FRANCO");
        register("GBP", "Libra Esterlina", "British Pound", QuoteModality.CASH, true,
                "LIBRA ESTERLINA", "LIBRA");
        register("JPY", "Yen Japonés", "Japanese Yen", QuoteModality.CASH, true,
                "YEN JAPONÉS", "YEN JAPONES", "YEN");
        register("UYU", "Peso Uruguayo", "Uruguayan Peso", QuoteModality.CASH, true,
                "PESO URUGUAYO", "PESO URU");
        register("CLP", "Peso Chileno", "Chilean Peso", QuoteModality.CASH, true,
                "PESO CHILENO", "PESO CHI");
        register("ZAR", "Rand Sudafricano", "South African Rand", QuoteModality.CASH, true,
                "RAND SUDAFRICANO", "RAND");
        register("CAD", "Dólar Canadiense", "Canadian Dollar", QuoteModality.CASH, true,
                "DÓLAR CANADIENSE", "DÓLAR CA..");
        register("AUD", "Dólar Australiano", "Australian Dollar", QuoteModality.CASH, true,
                "DÓLAR AUSTRALIANO", "DÓLAR AU..");
        register("MXN", "Peso Mexicano", "Mexican Peso", QuoteModality.CASH, true,
                "PESO MEXICANO", "PESO MEX");
        register("PEN", "Sol Peruano", "Peruvian Sol", QuoteModality.CASH, true,
                "SOL PERUANO", "SOL");
        register("BOB", "Peso Boliviano", "Bolivian Peso", QuoteModality.CASH, true,
                "PESO BOLIVIANO", "PESO BOL");
        register("COP", "Peso Colombiano", "Colombian Peso", QuoteModality.CASH, true,
                "PESO COLOMBIANO", "PESO COL");

        register("NOK", "Corona Noruega", "Norwegian Krone", QuoteModality.CASH, true);
        register("DKK", "Corona Danesa", "Danish Krone", QuoteModality.CASH, true);
        register("SEK", "Corona Sueca", "Swedish Krona", QuoteModality.CASH, true);
        register("KWD", "Dinar Kuwaiti", "Kuwaiti Dinar", QuoteModality.CASH, true);
        register("ILS", "Shekel Israelí", "Israeli Shekel", QuoteModality.CASH, true);
        register("RUB", "Rublo Ruso", "Russian Ruble", QuoteModality.CASH, true);
        register("CNY", "Yuan China", "Chinese Yuan", QuoteModality.CASH, true);
        register("TWD", "Dólar Taiwanés", "Taiwan Dollar", QuoteModality.CASH, true);
        register("SGD", "Dólar Singapur", "Singapore Dollar", QuoteModality.CASH, true);
    }
