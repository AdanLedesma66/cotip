...
import py.com.cotip.insfrastructure.external.cotipdb.BranchOfficeQueryDbOutPortImpl;
...
public class CotipConfigDb {
    ...
    @Bean
    public BranchOfficeQueryPort branchOfficeQueryPort(BranchOfficeRepository branchOfficeRepository) {
        return new BranchOfficeQueryDbOutPortImpl(branchOfficeRepository);
    }
